...
export class HomeComponent implements OnInit {
  ...
  handleSubmitInput(event) {
    ...
    $.get(
      `https://api.worldweatheronline.com/premium/v1/weather.ashx?key=0acb0aa11bcb4ec8a67114454181412&q=${event}&format=json&lang=vi`,
      res => {
        console.log(res)
        let cityName = [];
  ...
  ngOnInit() {
    ...
    this.handleSubmitInput(this.change_alias('Hà Nội'));
